                        ...
                        <td class="text-center">
                            <div class="action-group">
                                ...
                                <?php if ($role === 'resepsionis'): ?>
                                    <a href="upload-pdf.php?id=<?= (int) $t['id']; ?>" class="guest-action pdf <?= !empty($t['file_pdf']) ? 'uploaded' : ''; ?>" title="<?= !empty($t['file_pdf']) ? 'Lihat/Ganti PDF' : 'Upload PDF'; ?>"><i class="fas fa-file-pdf"></i></a>
                                <?php endif; ?>
